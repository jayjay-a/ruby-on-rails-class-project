...
board_list = [
    {name: 'J.U.L.I.U.S.',user_id:1,channel_id: 1},
    {name: 'Project N M A Dungeon', user_id:2 ,channel_id: 1},
    {name: 'Phoenix', user_id:3 ,channel_id: 2},
    {name: 'Migrations', user_id:4 ,channel_id: 2},
    {name: 'Q2 Promotional Items', user_id:5 ,channel_id: 3},
    {name: 'Novelty Inventory', user_id:2 ,channel_id: 3},
    {name: 'Margin Megathread', user_id:5 ,channel_id: 3},
    {name: 'CoT Grillfest', user_id:4 ,channel_id: 4},
    {name: 'Ruby Problems', user_id:3 ,channel_id: 5},
    {name: 'Rail Problems', user_id:2 ,channel_id: 5},
    {name: 'PSA: Try turning it on and off again', user_id:1 ,channel_id: 5},
    {name: 'Campus Recruiting at UH', user_id:1 ,channel_id: 4}
]
...
Post.delete_all
post_list = [
    { board_id: 1 ,   user_id: 1, message: 'j u l i u s' },
    { board_id: 2 ,   user_id: 2, message: 'Is it open yet?' },
    { board_id: 3 ,   user_id: 3, message: 'What is Elixir?' },
    { board_id: 4 ,   user_id: 4, message: 'What does db:migrate do?' },
    { board_id: 5 ,   user_id: 5, message: 'Why arent we running szechuan sauce? ' },
    { board_id: 6 ,   user_id: 1, message: 'What gag gift do you have to jolly your dolly?' },
    { board_id: 7 ,   user_id: 2, message: 'ALL IN JNUG?' },
    { board_id: 8 ,   user_id: 3, message: 'So who was it who was drinking at Grillfest but was not at work?' },
    { board_id: 9 ,   user_id: 4, message: 'student_age.sum?' },
    { board_id: 10 ,  user_id: 5, message: 'User.find("LandMASTER")?' },
    { board_id: 11 ,  user_id: 1, message: 'I tried to turn it on and off abut I could not turn it on.' },
    { board_id: 12 ,  user_id: 2, message: 'We are exclusively hiring from the CIS program.' },
    { board_id: 1 ,   user_id: 3, message: 'j a y j a y' },
    { board_id: 2 ,   user_id: 4, message: 'Open up Julius.' },
    { board_id: 3 ,   user_id: 5, message: 'A language for Phoenix' },
    { board_id: 4 ,   user_id: 1, message: 'It migrates the db' },
    { board_id: 5 ,   user_id: 2, message: 'You have to have a very high IQ to understand our marketing.' },
    { board_id: 6 ,   user_id: 3, message: 'What does that even mean?' },
    { board_id: 7 ,   user_id: 4, message: 'RIDING IT TO THE MOON' },
    { board_id: 8 ,   user_id: 5, message: 'Not me' },
    { board_id: 9 ,   user_id: 1, message: 'well it is no student_age.map?' },
    { board_id: 10 ,  user_id: 2, message: 'User.find("Fox") do each |barrelroll| ' },
    { board_id: 11 ,  user_id: 3, message: 'Is it plugged in?' },
    { board_id: 12 ,  user_id: 4, message: 'And only people who took Professor Lancaster.  ' },
]
